    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
        ...
        {actionNeeded && actionNeeded.summary.total > 0 && (
          <div
            className={`rounded-lg border p-3 flex items-center justify-between cursor-pointer ${actionNeeded.summary.high > 0 ? 'border-red-200 bg-red-50/50 dark:border-red-900 dark:bg-red-950/20' : 'border-amber-200 bg-amber-50/50 dark:border-amber-900 dark:bg-amber-950/20'}`}
