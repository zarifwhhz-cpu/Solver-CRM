...
import { LayoutDashboard, Megaphone, Upload, Bot, BarChart3, ListFilter, Settings2, AlertTriangle } from "lucide-react";
...
const items = [
  ...
  { title: "Action Needed", url: "/action-needed", icon: AlertTriangle },
